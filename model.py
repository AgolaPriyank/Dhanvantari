...
custom_prompt_template = """You are an Ayurveda Advisor. Use the following pieces of information to answer the user's question in detail. When discussing 
...
async def start():
    ...
    await msg.send()
    msg.content = "Hi, Welcome to Dhanvantari. What is your query?"
    await msg.update()
